...
contract TheBlockchain {
    string public name = "theblockchain";
    string public symbol = "PDT";
    string public standard = "theblockchain v.0.1";
    ...
    function transfer(
        ...
        emit Transer(msg.sender, _to, _value);
...
contract TokenStaking is Ownable, ReentrancyGuard, Initializable {
    ...
    uint256 _minimumStakingAmount; // minimum statking amount
    ...
    uint256 _totalStakedTokens; // total numbers of tokens that are staked
    ...
    function __TokenStaking_init_unchained(
        ...
        require(stakeDays_ > 0, "TokenStaking: stake days must benon-zero");
        require(
    ...
    // view methods start
    /**
     * @notice This function is used to get get the minimum staking amount
     */
    ...
    /**
     * @notice This function is used to get the user's details
     * @param userAddress User's address to get the details of
     ...
     *
     * @param amount the amout to stake
    ...
    function withdraw(uint256 amount) external onlyOwner nonReentrant {
        require(
            ...
            "TokenStaking: not enough withdrawble tokens"
        );
    ...
    /**
    * @notice This function is used to claim users's rewards
        ...
        whenTreasuryHasBalance(_users[msg.sender].rewardAmount)
    {
        ...
        require(
            ...
            "TokenStaking: failed to transer"
        );
